    ...
    <>
      <div className="fixed bottom-20 sm:bottom-24 right-4 sm:right-6 z-40 flex flex-col items-end group">
        ...
        <div className="relative w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 flex items-center justify-center">
          {/* Pulsing ring indicators - positioned behind button */}
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="absolute w-full h-full rounded-full bg-primary-400 opacity-60 animate-ping"></div>
            <div className="absolute w-full h-full rounded-full bg-primary-300 opacity-40 animate-pulse"></div>
          </div>
