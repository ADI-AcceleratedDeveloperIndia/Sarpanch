...
5. **Create a Google Sheet**
   ...
   - Add headers in row 1: `Timestamp`, `Name`, `Idea Work`, `Reason`, `Will Support`, `Election Person`
...
## Option 3: View Logs (Temporary)

For now, all feedback is logged to the server console. You can view it in:
- **Local development**: Terminal where `npm run dev` is running
- **Vercel**: Go to your project > Logs tab
...
5. **Do you know any person who will win Sarpanch elections?** (Optional)
